          ...
          <Card className="px-8 py-6 drop-shadow-xl drop-shadow-gray-900 border-2 border-gray-600">
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="one">Placeholder Game One</SelectItem>
                  <SelectItem value="two">Placeholder Game Two</SelectItem>
                  <SelectItem value="three">Placeholder Game Three</SelectItem>
                  <SelectItem value="four">Placeholder Game Four</SelectItem>
                </SelectContent>
              </Select>
            </div>
